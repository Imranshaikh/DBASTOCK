                  ...
                  while ($colresult = mysql_fetch_assoc($colorqry)) {
                    ...
                    ?>
                      <div class="swiper-slide">
                        <div>
                          <?php
                            $image = $allitems['imgpath'];
                            if(file_exists($image)){
                              echo "<img src='".$allitems['imgpath']."' class='img-responsive'>";
                            }else{
                              echo "<img src='upload/default.jpg' class='img-responsive'>";
                            }
                          ?>
                        </div>
